...
const SingleVehiclePage = ()=>{
    ...
    return(
        <div style={{position:"relative", fontFamily:"Poppins"}}>
            ...
            <div style={{marginLeft:"250px", height:"10px",width:"50%", position:"relative",left:"200px" ,borderBottom:"solid", borderWidth:"thin", paddingTop:"20px"}}></div>



            {/* COLLECTOR ASSIGNMENT */}
            <div style={{display:"flex", padding:"10px 0px"}}>
                <div style={{position:"relative", left:"250px", fontSize:"x-large",padding:"20px 0px 0px 10px"}}>COLLECTOR ASSIGNMENT</div>
            </div>
