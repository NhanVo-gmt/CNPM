...
const VehicleInformationComponent = ()=>{
    ...
    return(
        <div style={{position:"relative", left:"25%", width:"60%"}}>
            <div style={{position:"relative", left:"15%", fontSize:"xx-large", padding:"15px", fontWeight:"bold"}}>Vehicle Id</div>
            <div style={{border: "solid", borderRadius:"10px"}}>
                ...
                <div style={{display:"flex", justifyContent:"flex-start", padding:"15px 0px", paddingLeft:"10px", paddingBottom:"25px"}}>
                    <div style={{display  : "flex", flexDirection : "column"}}>
                        ...
                        <input type="text" style={{height:"30px", borderRadius:"5px"}}></input>
                    </div>
                ...
                <div style={{paddingLeft:"10px"}}>
                    <div style={{ display : "flex", flexDirection : "column"}}>
                        ...
                        <input value={bigBoxValue} onChange={(e)=>{updateBigBoxValue(e.currentTarget.value)}} type="text" style={{height:"100px", width:"300px", borderRadius:"5px", paddingBottom:"50px"}}></input>
                    </div>
                </div>
